        ...
        <div class="card-body">
            <form id="userForm" action="{{isset($user) ? url("users/$user->id") : url('users')}}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="email" autocomplete="off" name="email" value="{{isset($user) ? $user->email : ''}}" class="form-control">
                    <span class="text-danger">{{$errors->has('email') ? $errors->first('email') : ''}}</span>
                </div>
                <div class="form-group">
                    <label for="email">Birthday:</label>
                    <input type="date" name="birthday" value="{{isset($user) ? $user->birthday : ''}}" class="form-control">
