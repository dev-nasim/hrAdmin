...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <a href="{{ url('subdepartment') }}" type="button" class="btn btn-primary"><i class="fa fa-check"></i> Manage
                Department</a>
        </div>
        <div class="card-body">
            <form action="{{ url('department/' . $departments->id) }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="{{ $departments->department_name }}" class="form-control"
