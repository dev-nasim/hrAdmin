<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ url('dashboard') }}">
        ...
        <div class="sidebar-brand-text mx-3">{!! isset(appConfig()['app_title']) ? appConfig()['app_title'] : '' !!}</div>
    </a>
    ...
    <li class="nav-item">
        ...
        <div id="role" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="{{ url('role') }}">Role Manage</a>
            </div>
        </div>
    </li>
    ...
    <!-- Nav Item - Role Collapse Menu -->
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#user_role"
            aria-expanded="true" aria-controls="user_role">
            <i class="fa fa-user"></i>
            <span>User Role</span>
        </a>
        <div id="user_role" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="{{ url('user_role') }}">User Role</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#award" aria-expanded="true"
            aria-controls="award">
            <i class="fa fa-gift"></i>
            <span>Award</span>
        </a>
        <div id="award" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
    ...
    <li class="nav-item">
        ...
        <div id="holiday" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
